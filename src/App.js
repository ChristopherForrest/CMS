...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <Router>
          <Security issuer={'https://dev-493904.oktapreview.com/oauth2/default'} client_id={'0oai9gwg86y6bzzft0h7'} redirect_uri={'https://sandhurst-cms.herokuapp.com/implicit/callback'}>
